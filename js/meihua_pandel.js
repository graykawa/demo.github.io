...
if (localStorage.getItem("reset_2") == undefined) {
  ...
  if (localStorage.getItem("font") == undefined) {
    localStorage.setItem("font", "XWWK");
  }
  ...
  if (localStorage.getItem("blogbg") != undefined) {
    ...
    changeBg(curBg);
      ...
      // 替换你自己的默认背景
    let defaultBg = "url(https://gray-read.oss-cn-shanghai.aliyuncs.com/hexo-demo/cover/bz31.jpg)"
    let darkmodeBg = "url(https://gray-read.oss-cn-shanghai.aliyuncs.com/hexo-demo/cover/bz35.jpg)"
    let mobileDayBg = "url(https://gray-read.oss-cn-shanghai.aliyuncs.com/hexo-demo/cover/phone/bz3.png)"
    let mobileNightBg = "url(https://gray-read.oss-cn-shanghai.aliyuncs.com/hexo-demo/cover/phone/bz6.jpg)"
    document.getElementById("defineBg").innerText = `:root{
      --default-bg: ${defaultBg};
      --darkmode-bg: ${darkmodeBg};
      --mobileday-bg: ${mobileDayBg};
      --mobilenight-bg: ${mobileNightBg};
    }`;
    changeBg("url(https://gray-read.oss-cn-shanghai.aliyuncs.com/hexo-demo/cover/bz35.jpg)")
  }
  function changeBg(s) {
  ...
  <a class="swf" id="XWWK" href="javascript:;" rel="noopener external nofollow" style="font-family:'XWWK'!important;color:black" onclick="setFont('XWWK')">霞鹜文楷</a>
  <a class="swf" id="YSHST" href="javascript:;" rel="noopener external nofollow" style="font-family:'YSHST'!important;color:black" onclick="setFont('YSHST')">优设好身体</a>
  <a class="swf" id="HYTMR" href="javascript:;" rel="noopener external nofollow" style="font-family:'HYTMR'!important;color:black" onclick="setFont('HYTMR')">汉仪唐美人</a>
  <a class="swf" id="DYZMT" href="javascript:;" rel="noopener external nofollow" style="font-family:'DYZMT'!important;color:black" onclick="setFont('DYZMT')">电影字幕体</a>
  <a class="swf" id="JXZK" href="javascript:;" rel="noopener external nofollow" style="font-family:'JXZK'!important;color:black" onclick="setFont('JXZK')">江西拙楷</a>
