...
function changeFont(n,flag){
    if(n=="YSHST"){   
    document.body.style.fontFamily="YSHST, -apple-system, 'Quicksand', 'Nimbus Roman No9 L', 'PingFang SC', 'Hiragino Sans GB', 'Noto Serif SC', 'Microsoft Yahei', 'WenQuanYi Micro Hei', 'ST Heiti', sans-serif"
    }else{
...
function createWinbox() {
    ...
    <p><button onclick="localStorage.removeItem('blogbg');localStorage.removeItem('font');location.reload();" style="background:var(--lyx-theme);display:block;width:100%;padding: 15px 0;border-radius:6px;color:white;"><i class="fa-solid fa-arrows-rotate"></i> 点我恢复默认背景</button></p>

    <h2 id="主题色"><a href="#主题色" class="headerlink" title="主题色"></a>主题色</h2>
    <span class="content">
        <input type="radio" id="blue" name="colors" value=" " onclick="changeCol('#49B1F5')">
        <input type="radio" id="pink" name="colors" value=" " onclick="changeCol('#FFC0CB')">
    </span>
    <h2 id="字体"><a href="#字体" class="headerlink" title="字体"></a>字体</h2>
    <div style="width:100px;height:60px;font-family:'YSHST';text-align:center;line-height:60px;font-size:20px;border-radius:3px 3px 3px 3px;border:1px solid var(--lyx-theme);">优设好身体</div>
